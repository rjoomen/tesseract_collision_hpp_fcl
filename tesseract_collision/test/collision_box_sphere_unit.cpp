...
TEST(TesseractCollisionUnit, CoalDiscreteBVHCollisionBoxSphereUnit)  // NOLINT
{
  tesseract_collision_coal::CoalDiscreteBVHManager checker;
  test_suite::runTest(checker, false);
}

TEST(TesseractCollisionUnit, CoalDiscreteBVHCollisionBoxSphereConvexHullUnit)  // NOLINT
{
  tesseract_collision_coal::CoalDiscreteBVHManager checker;
  test_suite::runTest(checker, true);
}
